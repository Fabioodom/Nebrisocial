...
func NodeDetail(node *database.Node, messages []database.ChatMessage, threads []database.Thread, isAuthenticated bool, username string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"node-detail-container flex h-[calc(100vh-57px)] overflow-hidden w-full bg-bg-base\"><style>\n                .replies-list:empty {\n                    border-left: none !important;\n                    padding-left: 0 !important;\n                    margin-top: 0 !important;\n                    margin-bottom: 0 !important;\n                }\n            </style><!-- Columna Izquierda (Chat - 70%): flex-1 flex flex-col min-w-0 bg-bg-base --><div class=\"chat-column flex-1 flex flex-col min-w-0 bg-bg-base h-full\"><!-- Header del Nodo / Canal (Estilo Discord) --><div class=\"node-detail-header p-4 border-b border-border-subtle bg-bg-base flex-shrink-0\"><div class=\"breadcrumb mb-2\"><a href=\"/\">&#8592; Inicio</a> <span>/</span> <span>Nodo</span></div><div class=\"node-detail-title-row flex items-center gap-3\"><h1 class=\"node-title\" style=\"font-size: 1.4rem; margin-bottom: 0;\">")
			if templ_7745c5c3_Err != nil {
